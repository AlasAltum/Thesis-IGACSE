...
public class InputRecorder : Node
{
	...
	private const string REQUEST_URL = "https://IGACSE.azurewebsites.net/api/IGACSE?code=7x0mMQ-QgCsURHIl_KEPF0sl2MjsH3R4CKttXIsfF8IiAzFuApnNvA=="; // Enter here your API's url
