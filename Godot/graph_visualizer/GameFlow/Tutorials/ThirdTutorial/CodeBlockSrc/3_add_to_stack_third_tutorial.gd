...
After selecting the stack S, hover the mouse on the planet 0 and press R.
The selected variable will be shown on the bottom right panel. Check it after pressing R!
"""
