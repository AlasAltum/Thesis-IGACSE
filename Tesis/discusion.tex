...
\section{Fortalezas del software}
...
\section{Aspectos a mejorar del software}

A partir del \hyperref[AnexoG]{anexo G} se pueden identificar puntos de mejora. Entre estos, la legibilidad, colocación de títulos, elección de fuentes y colores se menciona en un total de 7 comentarios. Por otra parte, se sugieren cambios en la progresión de los desafíos 
